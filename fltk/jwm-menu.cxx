...
void MenuUI::cb_item_icon_button_i(Fl_Button*, void*) {
  Apps apps;apps.loadTemp();
const char *f = "/usr/share/pixmaps";
const char *m = "Choose an Icon";
const char *p = "*.{xbm,XBM,xpm,XPM,png,PNG,svg,SVG}";
...
void MenuUI::cb_Menu2_i(Fl_Button*, void*) {
  remove_a_menu();
}
void MenuUI::cb_Menu2(Fl_Button* o, void* v) {
  ((MenuUI*)(o->parent()->parent()->user_data()))->cb_Menu2_i(o,v);
}

void MenuUI::cb_Configure1_i(Fl_Button*, void*) {
  edit_an_item();
}
void MenuUI::cb_Configure1(Fl_Button* o, void* v) {
  ((MenuUI*)(o->parent()->parent()->user_data()))->cb_Configure1_i(o,v);
}
...
9, or a letter will typically require the use of a tray button or key binding."));
    ...
    { new_menu_label = new Fl_Input(170, 45, 120, 30, gettext("Label"));
    ...
    { menu_height = new Fl_Slider(170, 85, 120, 30, gettext("Height"));
...
t will determine the height. The default is 0."));
      ...
      menu_height->align(Fl_Align(FL_ALIGN_LEFT));
    } // Fl_Slider* menu_height
    { islabeled_button = new Fl_Check_Button(190, 15, 25, 25, gettext("Labeled        "));
...
t if the label is not set"));
      ...
      islabeled_button->align(Fl_Align(FL_ALIGN_RIGHT|FL_ALIGN_INSIDE));
...
Fl_Double_Window* MenuUI::add_window() {
  { Fl_Double_Window* o = adding_win = new Fl_Double_Window(350, 220, gettext("Add an Item"));
...
Fl_Double_Window* MenuUI::conf_item_window() {
  { Fl_Double_Window* o = config_item_win = new Fl_Double_Window(350, 145, gettext("Configure the Item"));
    config_item_win->user_data((void*)(this));
    { item_prog_label = new Fl_Input(80, 15, 160, 25, gettext("Label"));
      item_prog_label->box(FL_FLAT_BOX);
    } // Fl_Input* item_prog_label
    { item_prog_icon = new Fl_Input(80, 45, 160, 25, gettext("Icon"));
      item_prog_icon->box(FL_FLAT_BOX);
    } // Fl_Input* item_prog_icon
    { item_prog_input = new Fl_Input(80, 75, 160, 25, gettext("Program"));
      item_prog_input->box(FL_FLAT_BOX);
    } // Fl_Input* item_prog_input
    { item_conf_button = new Fl_Check_Button(85, 110, 90, 25, gettext("Confirm"));
      item_conf_button->box(FL_FLAT_BOX);
      item_conf_button->down_box(FL_GTK_DOWN_BOX);
    } // Fl_Check_Button* item_conf_button
    { item_prog_button = new Fl_Button(245, 75, 90, 25, gettext("Choose"));
    ...
    { item_icon_button = new Fl_Button(245, 45, 90, 25, gettext("Choose"));
...
Fl_Double_Window* MenuUI::configure_include() {
  { Fl_Double_Window* o = include_win = new Fl_Double_Window(325, 75, gettext("Edit Include Item"));
    ...
    { Fl_Button* o = new Fl_Button(250, 41, 60, 25, gettext("OK"));
      o->box(FL_FLAT_BOX);
      o->color((Fl_Color)61);
      o->labelcolor(FL_BACKGROUND2_COLOR);
      o->callback((Fl_Callback*)cb_OK4);
    } // Fl_Button* o
    { old_include_input = new Fl_Input(5, 40, 245, 25);
...
Fl_Double_Window* MenuUI::make_window() {
  load();
  saveChangesTemp();
  { Fl_Double_Window* o = menu_window = new Fl_Double_Window(320, 350, gettext("Menu proerties"));
    menu_window->color((Fl_Color)31);
    menu_window->user_data((void*)(this));
    { Fl_Scroll* o = new Fl_Scroll(0, 0, 320, 350);
      o->color((Fl_Color)31);
      { Fl_Button* o = new Fl_Button(160, 275, 140, 30, gettext("Configure Menu"));
      ...
      { Fl_Button* o = new Fl_Button(185, 315, 57, 25, gettext("Cancel"));
        o->box(FL_FLAT_BOX);
        o->color((Fl_Color)80);
      ...
      { save_button = new Fl_Button(251, 315, 49, 25, gettext("OK"));
      ...
      { Fl_Button* o = new Fl_Button(10, 235, 65, 30, gettext("@+  Item"));
      ...
      { Fl_Button* o = new Fl_Button(80, 235, 70, 30, gettext(" Item"));
      ...
      { Fl_Button* o = new Fl_Button(10, 275, 65, 30, gettext("@+  Menu"));
        o->tooltip(gettext("Add a menu item"));
        o->box(FL_FLAT_BOX);
        o->color((Fl_Color)23);
        o->selection_color(FL_DARK1);
      ...
      { Fl_Button* o = new Fl_Button(80, 275, 70, 30, gettext(" Menu"));
        o->tooltip(gettext("remove a menu item"));
        o->box(FL_FLAT_BOX);
        o->color((Fl_Color)23);
        o->image(image_minus);
        o->callback((Fl_Callback*)cb_Menu2);
        o->align(Fl_Align(256));
      } // Fl_Button* o
      { labler = new Fl_Output(180, 30, 125, 30, gettext("Label"));
        labler->box(FL_FLAT_BOX);
        labler->align(Fl_Align(FL_ALIGN_TOP));
      } // Fl_Output* labler
      { Fl_Button* o = new Fl_Button(160, 235, 140, 30, gettext("Configure Item"));
        o->tooltip(gettext("Choose a program to add"));
        o->box(FL_FLAT_BOX);
        o->color((Fl_Color)23);
        o->labelfont(1);
        o->callback((Fl_Callback*)cb_Configure1);
        o->align(Fl_Align(FL_ALIGN_WRAP));
      } // Fl_Button* o
      o->end();
    } // Fl_Scroll* o
...
Fl_Double_Window* MenuUI::submenu_window() {
  Fl_Double_Window* w;
  { Fl_Double_Window* o = new Fl_Double_Window(315, 295, gettext("Submenu"));
    w = o;
    o->user_data((void*)(this));
    { submenu_items_browser = new Fl_Browser(25, 25, 245, 160);
      submenu_items_browser->type(2);
      submenu_items_browser->box(FL_FLAT_BOX);
    } // Fl_Browser* submenu_items_browser
    { submenu_menu = new Fl_Output(180, 0, 25, 25);
      submenu_menu->hide();
    } // Fl_Output* submenu_menu
    { Fl_Input* o = new Fl_Input(155, 205, 135, 25);
      o->box(FL_FLAT_BOX);
    } // Fl_Input* o
    startup(o);
    o->end();
