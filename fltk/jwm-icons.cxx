...
Fl_Double_Window* IconsUI::make_window() {
  ...
  { Fl_Double_Window* o = icons_window = new Fl_Double_Window(320, 260, gettext("Icons"));
    ...
    { Fl_Scroll* o = new Fl_Scroll(0, 0, 316, 300);
      o->color((Fl_Color)31);
      ...
      { icon_themes_button = new Fl_Light_Button(101, 230, 75, 25, gettext("Themes"));
        icon_themes_button->box(FL_FLAT_BOX);
        icon_themes_button->value(1);
        icon_themes_button->selection_color(FL_GREEN);
        icon_themes_button->callback((Fl_Callback*)cb_icon_themes_button);
        icon_themes_button->hide();
        icon_themes_button->deactivate();
      ...
      { edit_button = new Fl_Button(140, 230, 40, 25, gettext("Edit"));
